...
macOS-версия ERNI Stream Downloader `1.2.2`.
...
- Для монтажных `MP4` делает один готовый файл:
  - H.264 video;
  - AAC audio;
  - constant frame rate для монтажных режимов;
  - 48 kHz stereo;
  - yuv420p.
...
```text
Сначала скачать локально, потом скопировать в выбранную папку
```
